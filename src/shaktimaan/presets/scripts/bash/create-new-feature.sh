...
# Resolve repository root using common.sh functions which prioritize .shaktimaan
...
if [ "$DRY_RUN" != true ]; then
    ...
    # Persist to .shaktimaan/feature.json so downstream commands can find the feature
