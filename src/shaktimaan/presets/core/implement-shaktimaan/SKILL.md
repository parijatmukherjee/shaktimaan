...
2. **Check checklists status** (if FEATURE_DIR/checklists/ exists):
   ...
   - `checklists/requirements.md` is the built-in spec-quality checklist maintained by `/specify-shaktimaan` and `/clarify-shaktimaan`; custom checklists generated by `/checklist-shaktimaan` are reviewer-owned requirements-quality review artifacts
...
3. Load and analyze the implementation context:
   ...
   - **IF EXISTS**: Read .shaktimaan/memory/constitution.md for governance constraints
